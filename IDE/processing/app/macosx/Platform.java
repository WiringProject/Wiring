...
public class Platform extends processing.app.Platform {
  ...
  public File getSettingsFolder() throws Exception {
    return new File(getLibraryFolder(), "Wiring");
  }


  public File getDefaultSketchbookFolder() throws Exception {
    return new File(getDocumentsFolder(), "Wiring");
    /*
    // looking for /Users/blah/Documents/Wiring
    try {
      ...
      sketchbookFolder = new File(documentsPath, "Wiring");
