 ...
 *
 * @author Slava Pestov
 * @version $Id: SyntaxUtilities.java 1238 2011-09-13 06:48:28Z h $
 */
public class SyntaxUtilities
{
  ...
  public static SyntaxStyle[] getDefaultSyntaxStyles()
  {
    ...
    styles[Token.URL] = new SyntaxStyle(new Color(0x990033),true,false,false);
  ...
  /**
   * Parse comments and identify a url pattern.
   * 
   * @param line
   *          A string to parse
