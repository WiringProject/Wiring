...
public class EditorStatus extends JPanel implements ActionListener {
  ...
  public EditorStatus(Editor editor) {
    ...
    if (bgcolor == null) {
      ...
      bgcolor[3] = Theme.getColor("status.prompt.bgcolor");
      bgcolor[4] = Theme.getColor("status.prompt.bgcolor");
      bgcolor[5] = Theme.getColor("status.notice.bgcolor");

      fgcolor = new Color[6]; //4];
      ...
      fgcolor[3] = Theme.getColor("status.prompt.fgcolor");
      fgcolor[4] = Theme.getColor("status.prompt.fgcolor");
