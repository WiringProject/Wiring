...
public class Platform extends processing.app.Platform {
  ...
  static final String openCommand =
    ...
    "\\processing.exe \"%1\"";
  static final String DOC = "Wiring.Document";
  ...
  // looking for Documents and Settings/blah/Application Data/Wiring
  public File getSettingsFolder() throws Exception {
    ...
    return new File(appDataPath, "Wiring");
  }


  // looking for Documents and Settings/blah/My Documents/Wiring
  public File getDefaultSketchbookFolder() throws Exception {
    ...
    return new File(personalPath, "Wiring");
  }
