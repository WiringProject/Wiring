...
public class EditorConsole extends JScrollPane {
  ...
  public EditorConsole(Editor editor) {
    ...
    setPreferredSize(new Dimension(this.editor.getSize().width, (height * lines) + sizeFudge));
    setMinimumSize(new Dimension(this.editor.getSize().width, (height * 4) + sizeFudge));
