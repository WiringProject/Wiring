...
public class UpdateCheck implements Runnable {
  Base base;
  String downloadURL = "http://wiring.org.co/download/latest.txt";
  ...
  public void run() {
    ...
    try {
      ...
      String prompt =
        "A new version of Wiring is available,\n" +
        "would you like to visit the Wiring download page?";
      ...
      if (base.activeEditor != null) {
        if (latest > Base.REVISION) {
          ...
          if (result == JOptionPane.YES_OPTION) {
            Base.openURL("http://wiring.org.co/download/");
          }
        }
      }
    } catch (Exception e) {
