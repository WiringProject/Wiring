/**
 * Dual axis gyroscope IDG1215 67 degreees per second, Sparkfun breakout
 * by BARRAGAN http://barraganstudio.com
 * 
 * Reads values from a gyroscope with X, Y connected to analog inputs 0 and 1 respectively
