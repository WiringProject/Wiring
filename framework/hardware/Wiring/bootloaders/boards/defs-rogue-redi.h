/* $Id: defs-rogue-redi.h 1178 2011-06-11 06:02:07Z bhagman $
||
...
|| | Rogue Robotics rEDI educational board.
|| |
...
//////////////////////////////////////////////////
// Standard STK500 based bootloader settings
//////////////////////////////////////////////////
...
#define LED_RX_PORT       PORTC
#define LED_RX_PIN        PINC4
#define LED_TX_PORT       PORTC
#define LED_TX_PIN        PINC7

#define LEDRXInitialize()   *(PORT_TO_DDR(LED_RX_PORT)) |= (1 << LED_RX_PIN)
#define LEDTXInitialize()   *(PORT_TO_DDR(LED_TX_PORT)) |= (1 << LED_TX_PIN)
#define LEDRXOff()          LED_RX_PORT |= (1 << LED_RX_PIN)
#define LEDTXOff()          LED_TX_PORT |= (1 << LED_TX_PIN)
#define LEDRXOn()           LED_RX_PORT &= ~(1 << LED_RX_PIN)
#define LEDTXOn()           LED_TX_PORT &= ~(1 << LED_TX_PIN)

// Number of times to flash LED on boot (one time)
// LED_FLASH_TIME is in milliseconds
// (We don't want any flashes on the rEDI board)
